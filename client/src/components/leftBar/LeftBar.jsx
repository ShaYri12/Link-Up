                    ...
                    {currentUser.profilePic ? (
                      <img src={
                        /^https?:\/\//.test(currentUser.profilePic)
                          ? currentUser.profilePic
                          : (currentUser.profilePic.startsWith("/upload/") || currentUser.profilePic.startsWith("upload/"))
                            ? (currentUser.profilePic.startsWith("/") ? currentUser.profilePic : `/${currentUser.profilePic}`)
